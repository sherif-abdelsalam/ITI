...
void DisplayEmployeeById(int empId, Employee *emps) {
...
void DisplayAllEmployees(Employee *emps) {
...
void DeleteEmployee(int empId, Employee *emps) {
    for (int i = 0; i < EmployeesInsertedIndex; i++) {
        if (emps[i].id == empId) {
...
int main() {
    ...
    Employee *emps = new Employee[emp_size];
    ...
    do {
        ...
        case 13: /// Enter
            ...
            case 0: /// Add new employee
                if (EmployeesInsertedIndex < emp_size)
