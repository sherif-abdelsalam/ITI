...
from products.views import product_delete, product_edit, product_list, product_detail, create_via_model_form, ProductModelForm
...
urlpatterns = [
    ...
    path('create/', create_via_model_form, name='products.create'),    
